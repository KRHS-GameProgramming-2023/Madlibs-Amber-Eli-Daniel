...
def Story4(debug = False):
    ...
    out += " decided to attack. Luckily, it wasn't a real attack, the " + creature1
    out += " just wanted to play " + game1
    out += " sadly, everyone was too scared to play with them and everyone ended up " + movementVerb1
    out += " away. Later on, " + name2
    out += ", the best friend of the " + creature1
    out += " wanted to cheer up their friend, so they got everyone together and they all played " + game2
